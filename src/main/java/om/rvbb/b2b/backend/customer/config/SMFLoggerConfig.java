...
import om.rvbb.b2b.backend.customer.util.SMFLogger;
...
public class SMFLoggerConfig {
	...
	@Before("within(com.smartoscfintech.p2plending.lms.backend.loan..*) "
			+ "&& @annotation(om.rvbb.b2b.backend.customer.util.SMFLogger)")
	...
	@AfterThrowing(value = "within(com.smartoscfintech.p2plending.lms.backend.loan..*) "
			+ "&& @annotation(om.rvbb.b2b.backend.customer.util.SMFLogger)", throwing = "e")
