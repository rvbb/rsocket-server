...
import com.smartoscfintech.p2plending.lms.backend.loan.util.SMFLogger;
...
public class SMFLoggerConfig {
	...
	@Before("within(com.smartoscfintech.p2plending.lms.backend.loan..*) "
			+ "&& @annotation(com.smartoscfintech.p2plending.lms.backend.loan.util.SMFLogger)")
	...
	@AfterThrowing(value = "within(com.smartoscfintech.p2plending.lms.backend.loan..*) "
			+ "&& @annotation(com.smartoscfintech.p2plending.lms.backend.loan.util.SMFLogger)", throwing = "e")
