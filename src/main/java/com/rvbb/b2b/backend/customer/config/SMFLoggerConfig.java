...
public class SMFLoggerConfig {
	...
	@Before("within(com.rvbb.b2b.backend.customer..*) "
			+ "&& @annotation(com.rvbb.b2b.backend.customer.util.SMFLogger)")
	...
	@AfterReturning("within(com.rvbb.b2b.backend.customer..*)"
			+ " && @annotation(com.rvbb.b2b.backend.customer.util.SMFLogger)")
	...
	@AfterThrowing(value = "within(com.rvbb.b2b.backend.customer..*) "
			+ "&& @annotation(com.rvbb.b2b.backend.customer.util.SMFLogger)", throwing = "e")
